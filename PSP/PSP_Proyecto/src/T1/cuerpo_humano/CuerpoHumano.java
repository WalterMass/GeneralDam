...
public class CuerpoHumano {
    ...
    public void infectar(String nombreVirus) throws InterruptedException {
        ...
        System.out.println("\nEl virus " + nombreVirus + " intenta entrar en el cuerpo");

        System.out.println("\nVirus en la cola = " + receptoresDisponibles.getQueueLength());

        receptoresDisponibles.acquire();
        //A partir de aqui hay una region compartida entre los que están
            //"dentro" del semaforo
        Thread.sleep(500);
            System.out.println("\n"+nombreVirus + " consigue un receptor e INFECTA el cuerpo");
        ...
        System.out.println("\n"+nombreVirus + " libera el receptor y hay espacio para " + permisosDisponibles);
